...
class BaseOverlay(pynq.Overlay):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.is_loaded():
            #LED R
            self.leds_red = self.leds_r.channel1
            self.leds_red.setdirection('out')
            self.leds_red.setlength(8)
            #LED G
            self.leds_green = self.leds_g.channel1
            self.leds_green.setdirection('out')
            self.leds_green.setlength(8)
            #LED B
            self.leds_blue = self.leds_b.channel1
            self.leds_blue.setdirection('out')
            self.leds_blue.setlength(8)
