...
The current `base` design was built using **Vivado 2025.2**. Other versions of Vivado are untested and are unlikely to build this design without modifications. 
